---
name: stallning-component
description: Create or modify UI components in the @stallning/ui package following Ark UI + CVA + design system patterns. Use when creating a new component, adding variants, extending component props, or working on the UI library.
---

# Stallning Component Development
