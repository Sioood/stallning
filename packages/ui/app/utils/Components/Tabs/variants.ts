...
export const tabsOptionIconCVA = cva('block shrink-0 self-center', {
  defaultVariants: {
    size: 'md',
  },
  variants: {
...
export const tabsTriggerLayoutCVA = cva('inline-flex items-center', {
  defaultVariants: {
...
export const tabsOptionLabelCVA = cva('min-w-0 truncate leading-none', {
  defaultVariants: {
    triggerLayout: 'inline',
  },
  variants: {
